...
public class PersonajeArtista extends Personaje {
    ...
    public void jugarVideojuegos() {
        ...
        this.felicidad = limitarValor(this.felicidad + 30); // Más felicidad
        this.inteligencia += 1; // Gana algo de inteligencia
    ...
    public void pasear() {
        ...
        this.felicidad = limitarValor(this.felicidad + 15); // Más felicidad
    ...
    public void degradarStatsPorTurno() {
        this.hambre = limitarValor(this.hambre + 2);
        this.sueno = limitarValor(this.sueno + 1.5);
        this.suciedad = limitarValor(this.suciedad + 2); // Más suciedad (manos manchadas)
        this.felicidad = limitarValor(this.felicidad - 0.1); // Casi no pierde felicidad
    }
