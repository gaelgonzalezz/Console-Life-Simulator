...
public abstract class Personaje {
	 protected String nombre;
	    ...
	    protected int supermanCounter = 0;
	    ...
	    public void superman() {
	        if (supermanCounter >= 1) {
	            System.out.println("⚠️ Ya has activado el cheat de Superman una vez, no puedes volver a activarlo.");
	            return;
	        }
	        System.out.println("🦸‍♂️ Cheat activado: ¡Superman!");
	        System.out.println("Se restauran tu vida, tu hambre y tu sueño.");
	    ...
	    public void hesoyam() {
	    	System.out.println("Has activado un cheat!");
	    	System.out.println("Se restaura tu vida y recibes $500.");
	    	this.vida = 100;
	    	this.dinero += 500;
	    }
